 ...
 * @author phanl
 */
@WebServlet(name = "ReservationDetailController", urlPatterns = {"/rsvdetail"})
...
//            int sid = Integer.parseInt(request.getParameter("sid")); 
            List<ReservationDetail> listrd = new ReservationDetailDAO().getRsvDetailByID(rsvid);
            request.setAttribute("listrd", listrd);
            request.getRequestDispatcher("view/rsvdetail.jsp").forward(request, response);
        } catch (Exception ex) {
