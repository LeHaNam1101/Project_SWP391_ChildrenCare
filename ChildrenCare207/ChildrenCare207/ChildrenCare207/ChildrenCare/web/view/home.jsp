...
<!--    <div class="container-fluid banner mb-5">
            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
                    <div class="bg-secondary d-flex flex-column p-5" style="height: 300px;">
                        ...
                        <p class="text-white">type here ! </p>
    ...
    <!-- Banner Start -->
 <div id="carouselExampleCaptions slider-list" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <c:forEach items="${listSlider}" var="s"> 
                    <a href="${s.backLink}" class="carousel-item abc">
                        <img src="images/${s.imageURL}" class="d-block w-100" alt="...">
                        <div class="slider-item carousel-caption d-none d-md-block " id="slider-item" style="position: relative;">
                            <h5 class="fw-bold fs-3" style="color: #0069d9">${s.slideTitle}</h5>
                        </div>
                    </a>
                </c:forEach>
            </div>
...
<!--    <div class =" image_slider">
        <img id="img" onclick="changeImage()" src="images/banner1.jpg" alt=""> 
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0">The World's Children Care That You Can Trust</h1>
                    </div>
                    <h4 class="text-body fst-italic mb-4">Type Information here</h4>
                    <p class="mb-4">More details here !</p>
                    <div class="row g-3">
...
<div class="container-fluid py-5">
            <div class="container">
                <div class="row g-5">
                    <c:forEach items="${listblogP}" var="o">
                        <div  class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                            <a  href="blogDetails?blogID=${o.blogID}" class="team-item">
                                <div class="position-relative rounded-top" style="">
                                    <img class="img-fluid rounded-top w-100" src="${o.imageURL}" alt="" class="w-100" style="height:300px ; object-fit: cover">
                                </div>
                                <div
                                    class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                                    <h4 class="mb-2"><a href="blogDetails?blogID=${o.blogID}" title="Title">${o.blogTitle}</a></h4>
                                    <p class="text-primary mb-0 blog-content">${o.blogContent}</p>
                                </div>
                            </a>
                        </div>
                    </c:forEach>
    ...
    <div class="d-flex justify-content-center">
        <a href="BlogList" class="btn btn-primary px-4 py-2 mt-3" >See More </a>
    </div>
        </div>
...
<!--    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="row g-5 mb-5">
                <div class="col-lg-5 wow zoomIn" data-wow-delay="0.3s" style="min-height: 50px;">
                    <div class="">
...
<!--                <div  class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="images/image_blog/blog1.jpg" alt="">
                            
                        </div>
                        <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                            <h4 class="mb-2">Detail 1 </h4>
                            <p class="text-primary mb-0" href="Team.jsp">When visiting a child care center, ask to see a copy of the program’s license, registration or certification, and inspection history.

Many states post inspection reports online.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="images/image_blog/blog2.jpg" alt="">
                            <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
                                
                            </div>
                        </div>
                        <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                            <h4 class="mb-2">Detail 2</h4>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="images/image_blog/blog3.jpg" alt="">
                            <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
                                
                            </div>
                        </div>
                        <div class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5">
                            <h4 class="mb-2">Detail 3</h4>
                            <p class="text-primary mb-0">Implant Surgeon</p>
                        </div>
                    </div>
                </div>-->
