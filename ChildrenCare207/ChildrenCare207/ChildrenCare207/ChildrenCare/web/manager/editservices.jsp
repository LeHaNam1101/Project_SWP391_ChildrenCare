                        ...
                        <form action="editservices" method="post">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    <label>ID</label>
                                    <input value="${s.serviceID}" name="id" type="number" class="form-control" readonly required>
                                </div>
                                <div class="form-group">
                                    <label>Tên - trên 6 ký tự</label>
                                    <input value="${s.serviceName}" name="name" type="text" class="form-control" required id="validate" name="validate" pattern="[A-Za-z].{6,}">
                                </div>
                                <div class="form-group">
                                    <label>Giá - lớn hơn 0</label>
                                    <input value="${s.servicePrice}" name="price" type="number" class="form-control" required min="0" max="9999999999" >
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Image</label>
                                    <img class="thumb" width="300" height="400" src="${s.imageURL}">
                                    <input type="file" id="svimg" class="form-control" name="svimg" onchange="changesvimg()" accept=".jpg, .jpeg, .png"><br>
                                    <span id="invalid2" style="color: red; display: none;"> <i class="fa fa-exclamation" aria-hidden="true"></i> 
                                        Please choose picture</span>    
                                    <input name="img" id="sendimg" type="hidden" value="${s.imageURL}">
                                </div>
                                <div class="form-group">
                                    <label>Mô Tả</label>
                                    <textarea  name="desc" type="text" class="form-control" required cols="40" rows="5">${s.serviceDetail}</textarea>
                                </div>
