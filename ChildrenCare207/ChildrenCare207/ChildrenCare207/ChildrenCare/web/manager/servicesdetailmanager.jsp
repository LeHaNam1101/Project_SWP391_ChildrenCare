...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="vi" class="loading-site no-js"> <!--<![endif]-->
    <head>
        ...
        <title>ChildenCare - Vì sức khỏe</title>
    ...
    <body data-rsssl=1 class="home page-template page-template-page-blank page-template-page-blank-php page page-id-89 theme-flatsome woocommerce-no-js header-shadow lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border">
        ...
        <div id="wrapper">
                ...
                <div class="page-title-inner flex-row medium-flex-wrap container">
                    <div class="flex-col flex-grow medium-text-center">
                        <div class="is-smaller">
                            <nav class="woocommerce-breadcrumb breadcrumbs uppercase"><a href="home">Trang chủ</a> <span class="divider">&#47;</span> <a href="filter-category-manager?cid=${c.categoryID}">${c.categoryName}</a></nav></div>
                    </div>
            ...
            <main id="main" class="">
                ...
                <div class="shop-container">
                    ...
                    <div id="product-32017" class="product type-product post-32017 status-publish first outofstock product_cat-ao-mixi has-post-thumbnail shipping-taxable purchasable product-type-variable">
                            ...
                            <div class="product-main">
                                <div class="row content-row mb-0">
                                            ...
                                            <div class="col large-10">
                                                ...
                                                <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images relative mb-half has-hover" data-columns="4">
                                                    ...
                                                    <figure class="woocommerce-product-gallery__wrapper product-gallery-slider slider slider-nav-small mb-0 has-image-zoom"
                                                            ...
                                                            "pageDots": false,
                                                            "rightToLeft": false       }'>
                                                        <div data-thumb="Services/${s.serviceID}" class="woocommerce-product-gallery__image slide first">
                                                            <a href="${s.imageURL}"><img  src="${s.imageURL}" class="wp-post-image skip-lazy" alt="Apcitylogoden" loading="lazy" title="Apcitylogoden" data-caption="" data-src="${s.imageURL}" data-large_image="${s.imageURL}" data-large_image_width="1706" data-large_image_height="2560" 
                                    ...
                                    <div class="product-info summary col-fit col entry-summary product-summary text-left form-flat">
                                        ...
                                        <h1 class="product-title product_title entry-title" style="color: #0a4da8; font-weight:  bolder">
                                            ${s.serviceName}</h1>
                                        <p style="font-style: italic; font-weight: bold; color: rgba(102,102,102,0.85)">Danh mục: ${c.categoryName}</p>
                                        ...
                                        <div class="price-wrapper">
                                            ...
                                            <p class="price product-page-price price-not-in-stock">
                                                <span class="woocommerce-Price-amount amount" style="font-style: italic;">
                                                    <bdi><fmt:formatNumber value="${s.servicePrice}" minFractionDigits="0" maxFractionDigits="0"/><span class="woocommerce-Price-currencySymbol">.000&#8363;</span></bdi></span></p>
                                        </div>
                                        ...
                                        <div>
                                            <a  class="button alt" style=" background-color: #0a4da8" href="loadservices?sid=${s.serviceID}">Sửa </a>

                                            <a class="button alt" href="deleteservices?did=${s.serviceID}" onclick="return confirm('Bạn có chắc chắn muốn xóa dịch vụ khỏi danh sách?');">Delete</a>
                            ...
                            <div class="product-footer">
                                <div class="container">
                                        ...
                                        <div class="tab-panels">
                                            <div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--additional_information panel entry-content active" id="tab-additional_information" role="tabpanel" aria-labelledby="tab-title-additional_information">
                                                ...
                                                <table class="woocommerce-product-attributes shop_attributes">
                                                    <tr class="woocommerce-product-attributes-item woocommerce-product-attributes-item--attribute_pa_size-mixicity">

                                                        <td class="woocommerce-product-attributes-item__value"><p>${s.serviceDetail}</p>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                    ...
                                    <div class="related related-products-wrapper product-section">
                                        ...
                                        <h3 class="product-section-title container-width product-section-title-related pt-half pb-half uppercase d-flex justify-content-center " style="color: #111; font-weight: bold;font-style: italic;">Dịch vụ tương tự			</h3>
                                        ...
                                        <div class="row large-columns-4 medium-columns-3 small-columns-2 row-small slider row-slider slider-nav-reveal slider-nav-push"  data-flickity-options='{"imagesLoaded": true, "groupCells": "100%", "dragThreshold" : 5, "cellAlign": "left","wrapAround": true,"prevNextButtons": true,"percentPosition": true,"pageDots": false, "rightToLeft": false, "autoPlay" : false}'>
                                            ...
                                            <c:forEach items="${relateS}" var="rs">

                                                <div class="product-small col has-hover product type-product post-32012 status-publish instock product_cat-ao-mixi has-post-thumbnail shipping-taxable purchasable product-type-variable">
                                                    <div class="col-inner">
                                                        ...
                                                        <div class="product-small box ">
                                                            <div class="box-image">
                                                                <div class="image-fade_in_back">
                                                                    <a href="detail?sid=${rs.serviceID}">
                                                                        <img width="300" height="400" src="Services/${rs.imageURL}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Anilogomxgden" loading="lazy" />				</a>
                                                                </div>
                                                            ...
                                                            <div class="box-text box-text-products text-center grid-style-2">
                                                                <div class="title-wrapper">		
                                                                    <p class="name product-title woocommerce-loop-product__title" style="font-weight: bold;"><a href="detail?sid=${rs.serviceID}" class="woocommerce-LoopProduct-link woocommerce-loop-product__link" >${rs.serviceName}</a></p></div><div class="price-wrapper">
                                                                    <span class="price"><span class="woocommerce-Price-amount amount" style="font-style: italic;">
                                                                            <bdi><fmt:formatNumber value="${s.servicePrice}" minFractionDigits="0" maxFractionDigits="0"/><span class="woocommerce-Price-currencySymbol">.000&#8363;</span></bdi></span></span>
                                                                    <div>
                                                                        <a  class="button alt" style=" background-color: #0a4da8" href="loadservices?sid=${s.serviceID}">Sửa </a>
                ...
                <ul class="nav nav-sidebar nav-vertical nav-uppercase">
                    ...
                    <li id="menu-item-20084" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-20084"><a>ÁO</a>
                        <ul class="sub-menu nav-sidebar-ul children">
                            <li id="menu-item-7119" class="label-new menu-item menu-item-type-taxonomy menu-item-object-product_cat current-product-ancestor current-menu-parent current-product-parent menu-item-7119"><a href="https://shop.mixigaming.com/danh-muc/ao-mixi/">ÁO MIXI</a></li>
                ...
                <div class="account-login-inner">
                    ...
                    <form class="woocommerce-form woocommerce-form-login login" method="post">
                        ...
                        <p class="form-row">
                            ...
                            <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="e5cc2220af" /><input type="hidden" name="_wp_http_referer" value="/san-pham/ao-phong-mixicity-logo-be-den/" />						<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Đăng nhập">Đăng nhập</button>
                        </p>
        ...
        <script type='text/javascript' src='https://shop.mixigaming.com/wp-content/plugins/woocommerce/assets/js/photoswipe/photoswipe.min.js' id='photoswipe-js'></script>
        <script type='text/javascript' src='https://shop.mixigaming.com/wp-content/plugins/woocommerce/assets/js/photoswipe/photoswipe-ui-default.min.js' id='photoswipe-ui-default-js'></script>
        <script type='text/javascript' id='wc-single-product-js-extra'>
            /* <![CDATA[ */
            var wc_single_product_params = {"i18n_required_rating_text":"Vui l\u00f2ng ch\u1ecdn m\u1ed9t m\u1ee9c \u0111\u00e1nh gi\u00e1", "review_rating_required":"yes", "flexslider":{"rtl":false, "animation":"slide", "smoothHeight":true, "directionNav":false, "controlNav":"thumbnails", "slideshow":false, "animationSpeed":500, "animationLoop":false, "allowOneSlide":false}, "zoom_enabled":"", "zoom_options":[], "photoswipe_enabled":"1", "photoswipe_options":{"shareEl":false, "closeOnScroll":false, "history":false, "hideAnimationDuration":0, "showAnimationDuration":0}, "flexslider_enabled":""};
            /* ]]> */
        </script>
        <script type='text/javascript' src='https://shop.mixigaming.com/wp-content/plugins/woocommerce/assets/js/frontend/single-product.min.js' id='wc-single-product-js'></script>
        ...
        <script type='text/javascript' src='https://shop.mixigaming.com/wp-includes/js/comment-reply.min.js' id='comment-reply-js'></script>
        <!--[if IE]>
        <script type='text/javascript' src='https://cdn.jsdelivr.net/gh/nuxodin/ie11CustomProperties@4.0.1/ie11CustomProperties.min.js' id='css-vars-polyfill-js'></script>
        <![endif]-->
        <script type='text/javascript' src='https://shop.mixigaming.com/wp-includes/js/underscore.min.js' id='underscore-js'></script>
        <script type='text/javascript' id='wp-util-js-extra'>
            /* <![CDATA[ */
            var _wpUtilSettings = {"ajax":{"url":"\/wp-admin\/admin-ajax.php"}};
            /* ]]> */
        </script>
        <script type='text/javascript' src='https://shop.mixigaming.com/wp-includes/js/wp-util.min.js' id='wp-util-js'></script>
        <script type='text/javascript' id='wc-add-to-cart-variation-js-extra'>
            /* <![CDATA[ */
            var wc_add_to_cart_variation_params = {"wc_ajax_url":"\/?wc-ajax=%%endpoint%%", "i18n_no_matching_variations_text":"R\u1ea5t ti\u1ebfc, kh\u00f4ng c\u00f3 s\u1ea3n ph\u1ea9m n\u00e0o ph\u00f9 h\u1ee3p v\u1edbi l\u1ef1a ch\u1ecdn c\u1ee7a b\u1ea1n. H\u00e3y ch\u1ecdn m\u1ed9t ph\u01b0\u01a1ng th\u1ee9c k\u1ebft h\u1ee3p kh\u00e1c.", "i18n_make_a_selection_text":"Ch\u1ecdn c\u00e1c t\u00f9y ch\u1ecdn cho s\u1ea3n ph\u1ea9m tr\u01b0\u1edbc khi cho s\u1ea3n ph\u1ea9m v\u00e0o gi\u1ecf h\u00e0ng c\u1ee7a b\u1ea1n.", "i18n_unavailable_text":"R\u1ea5t ti\u1ebfc, s\u1ea3n ph\u1ea9m n\u00e0y hi\u1ec7n kh\u00f4ng t\u1ed3n t\u1ea1i. H\u00e3y ch\u1ecdn m\u1ed9t ph\u01b0\u01a1ng th\u1ee9c k\u1ebft h\u1ee3p kh\u00e1c."};
            /* ]]> */
        </script>
        <script type='text/javascript' src='https://shop.mixigaming.com/wp-content/plugins/woocommerce/assets/js/frontend/add-to-cart-variation.min.js' id='wc-add-to-cart-variation-js'></script>
...
<!-- Cached page generated by WP-Super-Cache on 2022-02-27 20:54:07 -->
